...
import com.example.instagram.ui.profile.ViewPagerAdapter
import com.example.instagram.ui.profile.PostGridListFragment
...
class ViewUserFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        body.viewPager2.adapter = ViewPagerAdapter(this, fragments)
